...
| Backup reserve (read back) | — | % | `backupReverseSoc` | D ○ |
| Charge upper limit (read back) | — | % | `cmsMaxChgSoc` | D ○ |
| Discharge lower limit (read back) | — | % | `cmsMinDsgSoc` | D ○ |
...
| Energy backup enabled | — | `energyBackupEn` | D |
