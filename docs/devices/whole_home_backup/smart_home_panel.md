...
| Backup full capacity | energy_storage | Wh | `heartbeat.backupFullCap` | D |
| Grid energy today | energy | Wh | `heartbeat.gridDayWatth` |  |
| Backup energy today | energy | Wh | `heartbeat.backupDayWatth` |  |
| Backup discharge time remaining | duration | min | `heartbeat.backupChaTime` | D |
| Device work time | duration | min | `heartbeat.workTime` | D ○ |
| Grid voltage | voltage | V | `gridInfo.gridVol` | D |
| Grid frequency | frequency | Hz | `gridInfo.gridFreq` | D |
| Charge upper threshold | battery | % | `backupChaDiscCfg.forceChargeHigh` | D |
| Discharge lower threshold | battery | % | `backupChaDiscCfg.discLower` | D |
| Channel 1 state | — | — | _computed_ |  |
| Channel 1 configured current | current | A | _computed_ | D |
| Channel 1 backup priority | — | — | _computed_ | D |
| Channel 2 state | — | — | _computed_ |  |
| Channel 2 configured current | current | A | _computed_ | D |
| Channel 2 backup priority | — | — | _computed_ | D |
| Channel 3 state | — | — | _computed_ |  |
| Channel 3 configured current | current | A | _computed_ | D |
| Channel 3 backup priority | — | — | _computed_ | D |
| Channel 4 state | — | — | _computed_ |  |
| Channel 4 configured current | current | A | _computed_ | D |
| Channel 4 backup priority | — | — | _computed_ | D |
| Channel 5 state | — | — | _computed_ |  |
| Channel 5 configured current | current | A | _computed_ | D |
| Channel 5 backup priority | — | — | _computed_ | D |
| Channel 6 state | — | — | _computed_ |  |
| Channel 6 configured current | current | A | _computed_ | D |
| Channel 6 backup priority | — | — | _computed_ | D |
| Channel 7 state | — | — | _computed_ |  |
| Channel 7 configured current | current | A | _computed_ | D |
| Channel 7 backup priority | — | — | _computed_ | D |
| Channel 8 state | — | — | _computed_ |  |
| Channel 8 configured current | current | A | _computed_ | D |
| Channel 8 backup priority | — | — | _computed_ | D |
| Channel 9 state | — | — | _computed_ |  |
| Channel 9 configured current | current | A | _computed_ | D |
| Channel 9 backup priority | — | — | _computed_ | D |
| Channel 10 state | — | — | _computed_ |  |
| Channel 10 configured current | current | A | _computed_ | D |
| Channel 10 backup priority | — | — | _computed_ | D |
