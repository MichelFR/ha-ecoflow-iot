...
# (HJ31ZDH2ZF690029/25); "J32E" is an observed real-world prefix. The app keys
# on the family codes "HJ3"/"J32", so match those to catch all variants.
_SN_PREFIXES = ("HJ3", "J32")
