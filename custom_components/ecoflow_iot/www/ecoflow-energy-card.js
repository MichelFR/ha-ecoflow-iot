...
`;function cr(_){let i=[];for(let r=1;r<=4;r++){let l=_._config.panels?.[r]||{};if(l.hidden)continue;let h=`sensor.pv${r}_power`,g=_._state(h);g&&i.push({i:r,watts:pt(g),id:_._entityId(h),name:l.name||null})}return i}function Oa(_){let i=(g,E)=>Ft(_.hass,g,E),r=cr(_);if(!r.length)return I`<div class="empty">${i("panels.none")}</div>`;let l=Math.max(1,...r.map(g=>g.watts||0)),h=r.reduce((g,E)=>g+(E.watts||0),0);return I`<div class="panels">
    ${r.map(g=>I`<div
  ...
  </div>`}var gs=1e3,dr=340,Et={l:46,r:14,t:16,b:28};function Va(_,{actual:i,forecast:r,totalWh:l,forecastWh:h,currentHour:g,showForecast:E,title:D}){let U=(Z,St)=>Ft(_.hass,Z,St),j=gs-Et.l-Et.r,nt=dr-Et.t-Et.b,X=j/24,rt=Z=>Et.l+Z/24*j,at=0;for(let Z=0;Z<24;Z++)at=Math.max(at,(i[Z]||0)/1e3),E&&(at=Math.max(at,(r[Z]||0)/1e3));let ot=qo(at>0?at:.1),ce=Z=>Et.t+nt-Z/ot*nt,Nt=X*.66,Kt=[];for(let Z=0;Z<24;Z++){let St=(i[Z]||0)/1e3;if(St<=0)continue;let Se=rt(Z+.5)-Nt/2,Ue=ce(St),Ne=Z===g?"fc-actual fc-current":"fc-actual";Kt.push(Ht`<rect class=${Ne} x=${Se.toFixed(1)} y=${Ue.toFixed(1)}
        width=${Nt.toFixed(1)} height=${(Et.t+nt-Ue).toFixed(1)} rx="2"></rect>`)}let ee=null;if(E){let Z=[];for(let St=0;St<=24;St++)Z.push(`${rt(St).toFixed(1)},${ce((r[St]||0)/1e3).toFixed(1)}`);ee=Ht`<polyline class="fc-line" points=${Z.join(" ")}></polyline>`}let Wt=[],Hi=4;for(let Z=0;Z<=Hi;Z++){let St=ot/Hi*Z,Se=ce(St);Wt.push(Ht`<line class="fc-grid" x1=${Et.l} y1=${Se.toFixed(1)} x2=${gs-Et.r} y2=${Se.toFixed(1)}></line>`),Wt.push(Ht`<text class="fc-axis fc-axis-y" x=${Et.l-6} y=${(Se+4).toFixed(1)}>${Go(St)}</text>`)}let vi=[];for(let Z=0;Z<=24;Z+=4)vi.push(Ht`<text class="fc-axis fc-axis-x" x=${rt(Z).toFixed(1)} y=${dr-8}>${Z}:00</text>`);let Lt=E&&h>0&&l!=null?Math.round(l/h*100):null,ii=Z=>{_._fcTip!==Z&&(_._fcTip=Z,_.requestUpdate())},ie=()=>{_._fcTip!=null&&(_._fcTip=null,_.requestUpdate())},Cs=[];for(let Z=0;Z<24;Z++)Cs.push(Ht`<rect class="fc-hit" x=${rt(Z).toFixed(1)} y=${Et.t} width=${X.toFixed(1)} height=${nt}
    ...
    ${E?I`<div class="fc-graph-legend">
      ...
      </ha-card>`}_dialogFrame(i,r,l="medium"){return I`<ha-adaptive-dialog
      open
      width=${l}
      header-title=${i}
    ...
    </ha-adaptive-dialog>`}_imageSrc(i){let r=i?.device?.model;return ye(this._config.image_url||(this._config.image?ui(this._config.image):$a(r)),this.hass)}_renderHead(i){let r=this._config.title,l=r&&ct(r)?String(this._templateResults?.[r]??""):r,h=i.device?.model,g=l||i.device?.name_by_user||i.device?.name||h||this._t("card.device"),E=this._imageSrc(i);return I`<div class="head">
      <div class="head-left">
    ...
    >
      ...
      ${l&&X?I`<div class="batt-particles ${X} ${rt?"show":""}">
      ...
      ${rt.length?I`<div class="batt-grid">
            ${rt.map(at=>{let ot=this._entityId(at.slot);return I`<div
      ...
      ${i.map(r=>{let l=r.swState?.state==="on",h=pt(r.pwState);return I`<div
    ...
    </div>`:""}_toggleSwitch(i,r){let l=this._entityId(i),h=l?this.hass.states[l]:null;!l||!h||(h.state==="on"?this._confirmAc={slot:i,label:r}:this.hass.callService("switch","turn_on",{entity_id:l}))}_renderConfirmAc(){let{label:i}=this._confirmAc,r=()=>this._confirmAc=null;return I`<ha-adaptive-dialog
      open
      width="small"
    ...
    >`}_renderStats(){if(Array.isArray(this._config.stats))return I`<div class="stats custom">
      ...
      </div>`;let i=pt(this._state("sensor.pv_total")),r=cr(this),l=this._show("show_panels")&&r.length>0,h=this._state("sensor.grid_power"),g=pt(h);return I`<div class="stats">
      <div
      ...
      >
        <div class="stat-head">
          ...
          ${l?I`<ha-icon class="more" icon="mdi:chevron-right"></ha-icon>`:""}
        </div>
        <div class="stat-value">${this._metric(he(i))}</div>
        ${l?I`<div class="stat-sub">
              ${r.length} ${this._t("panels.title").toLowerCase()}
            </div>`:""}
      </div>
      ${this._show("show_grid")?this._renderGrid(g):I`<div></div>`}
    </div>`}_renderGrid(i){let r=i!=null&&i>1,l=i!=null&&i<-1,h=r?"import":l?"export":"",g=r?this._t("card.grid_import"):l?this._t("card.grid_export"):this._t("card.grid_idle");return I`<div
    ...
    </div>`}_renderCustomStat(i){if(!i||!i.entity&&!i.name)return I``;let r=i.entity?this.hass.states[i.entity]:void 0,l=i.name||r?.attributes?.friendly_name||i.entity||"",h=i.tap_action,g=!h||h.action!=="none";return I`<div
    ...
    </div>`}_statValue(i){let r=i?.state;if(r==null||r==="unavailable"||r==="unknown")return{n:"\u2013",u:""};let l=pt(i),h=i.attributes?.unit_of_measurement||"";return l==null?{n:r,u:""}:h==="W"?he(l):{n:Number.isInteger(l)?String(l):l.toFixed(1),u:h}}_handleAction(i,r){let l=i||{action:"more-info"},h=l.action||"more-info";if(h!=="none"){if(l.confirmation){let g=l.confirmation.text||this._t("card.confirm_action")||"Are you sure?";if(!window.confirm(g))return}switch(h){case"more-info":this._moreInfoId(l.entity||r);return;case"toggle":{let g=l.entity||r;g&&this.hass.callService("homeassistant","toggle",{entity_id:g});return}case"navigate":l.navigation_path&&(history.pushState(null,"",l.navigation_path),this.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1},bubbles:!0,composed:!0})));return;case"url":l.url_path&&window.open(l.url_path,l.new_tab===!1?"_self":"_blank");return;case"perform-action":case"call-service":{let g=l.perform_action||l.service,[E,D]=(g||"").split(".",2);E&&D&&this.hass.callService(E,D,l.data||l.service_data||{},l.target);return}default:this._moreInfoId(l.entity||r)}}}_forecastGraph(){let i=this._dataRange().ref,r=this._mergedForecast();return Va(this,{title:this._periodLabel(),actual:this._hourly||{},forecast:nr(r,i),totalWh:this._todayWh,forecastWh:or(r,i),currentHour:this._isToday()?new Date().getHours():null,showForecast:this._show("show_forecast")&&Object.keys(this._forecasts||{}).length>0})}_renderToday(){let i=this._todayWh!=null?this._todayWh/1e3:null,r=Object.keys(this._forecasts||{}).length>0,l=this._show("show_forecast")&&r?this._forecastTodayKWh():null,h=l!=null&&l>0,g=h&&i!=null?Math.min(100,Math.round(i/l*100)):null,E=g!=null&&g>=100;return I`<div
    ...
    >
      ...
      </div>`}_summary(i){if(i==="panels"){let E=this._detectedPanels(),D=E.filter(j=>this._config.panels?.[j]?.hidden).length,U=this._t("editor.panels_count",{n:E.length});return D&&(U+=` \xB7 ${this._t("editor.panels_hidden",{n:D})}`),U}if(i==="forecast"){let E=this._providers;if(E===void 0)return this._t("editor.automatic");if(!E.length)return this._t("editor.forecast_none_short");let D=this._config.forecast_config_entries,U=D===void 0?E.length:D.length;return this._t("editor.forecast_selected",{n:U,total:E.length})}if(i==="stats"){let E=this._config.stats;return Array.isArray(E)?this._t("editor.stats_count",{n:E.length}):this._t("editor.stats_default")}if(i==="advanced")return this._config.collection_key||this._t("editor.none");let r=(Na[i]||[]).filter(([E])=>this._config.entities?.[E]).length,l=r?` \xB7 ${this._t("editor.overridden",{n:r})}`:"",h=Ua[i]||[];if(!h.length)return r?this._t("editor.overridden",{n:r}):this._t("editor.automatic");let g=h.filter(([E,D])=>this._config[E]??D);return g.length?g.map(([E])=>this._t(`short.${E}`)).join(", ")+l:`${this._t("editor.nothing_shown")}${l}`}_renderSubpage(i){return I`<div class="subpage-head">
      ...
      <div class="stats-actions">
        ...
        </button>`}_renderStatBlock(i,r,l){let h=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"tap_action",selector:{ui_action:{}}}],g=i.name||i.entity||this._t("editor.stat_n",{n:r+1});return I`<div class="panel-block">
      ...
      ${r?I`<img
          ...
          />`:""}
    </span>`}_toggleProvider(i,r){let l=(this._providers||[]).map(E=>E.id),h=this._config.forecast_config_entries??l.slice();h=r?[...new Set([...h,i])]:h.filter(E=>E!==i);let g={...this._config,type:`custom:${Mt}`};h.length===l.length&&l.every(E=>h.includes(E))?delete g.forecast_config_entries:g.forecast_config_entries=h,this._dispatch(g)}_detectedPanels(){let i=this._defaults(),r=[];for(let l=1;l<=Xo;l++)(i[`sensor.pv${l}_power`]||this._config.entities?.[`sensor.pv${l}_power`])&&r.push(l);return r.length?r:[1,2,3,4]}_renderPanelsPage(){return I`<div class="hint top-hint">${this._t("editor.panels_hint")}</div>
      ${this._detectedPanels().map(i=>this._renderPanelConfig(i))}`}_renderPanelConfig(i){let r=this._config.panels?.[i]||{},l=!!r.hidden,h=`sensor.pv${i}_power`;return I`<div class="panel-block">
      <div class="panel-title-row">
      ...
      ${l?I`<div class="hint">${this._t("editor.panel_hidden")}</div>`:I`<ha-form
              .hass=${this.hass}
              .data=${{value:r.name||""}}
              .schema=${[{name:"value",selector:{text:{}}}]}
    ...
    </div>`}_withPanel(i,r){let l={...this._config.panels||{}},h={...l[i]||{}};for(let[E,D]of Object.entries(r))D===""||D==null||D===!1?delete h[E]:h[E]=D;Object.keys(h).length?l[i]=h:delete l[i];let g={...this._config,panels:l,type:`custom:${Mt}`};return Object.keys(l).length||delete g.panels,g}_renderToggle(i,r,l){return I`<div class="row">
      ...
      ></ha-switch>
    </div>`}_slotMode(i,r){return this._modes[i]?this._modes[i]:r?gt(r)&&!ct(r)?"entity":"custom":Ba.has(i)?"entity":"auto"}_renderModeChips(i,r){let l=Ba.has(i)?["entity","custom"]:["auto","entity","custom"];return I`<div class="modes">
      ${l.map(h=>I`<button
          class="mode ${r===h?"on":""}"
    ...
    </div>`}_renderSlot(i,r,l){let h=this._config.entities?.[i]||"",g=this._slotMode(i,h),E=this._defaults()[i];return I`<div class="section">
...
`;var ks=class extends kt{static styles=Xa;static get properties(){return{hass:{},_config:{}}}constructor(){super(),this._flows=new gi}connectedCallback(){super.connectedCallback(),Yt()}disconnectedCallback(){super.disconnectedCallback(),this._flows.destroy()}setConfig(i){this._config=i||{}}static getConfigElement(){return document.createElement(`${Qt}-editor`)}static getStubConfig(){return{house:It}}getCardSize(){return 7}_t(i,r){return Ft(this.hass,i,r)}_show(i,r=!0){return this._config[i]??r}get _device(){let i=oe(this.hass);return i.length?this._config.device&&i.find(r=>r.deviceId===this._config.device)||i[0]:null}_state(i){let r=this._config.entities?.[i];if(r)return gt(r)&&!ct(r)?this.hass.states[r]:{state:r,attributes:{}};let l=this._map?.[i];return l?this.hass.states[l]:void 0}_entityId(i){let r=this._config.entities?.[i];return r&&gt(r)&&!ct(r)?r:this._map?.[i]}_moreInfo(i){let r=this._entityId(i);r&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:r},bubbles:!0,composed:!0}))}_grid(){let i=this._state("sensor.grid_power");return pt(i??this._state("sensor.sys_grid_power"))}_flowStates(){let i=parseInt(this._config.house||It,10)||1;if(!this._device)return{grid:-400,solar:1500,load:700,bat:500,soc:65,route:i};let r=this._grid(),l=pt(this._state("sensor.pv_total")),h=pt(this._state("sensor.sys_load")),g=pt(this._state("sensor.bat_power")),E=pt(this._state("sensor.cms_batt_soc"));return{grid:r,solar:l,load:h,bat:g,soc:E,route:i}}updated(i){super.updated(i),this._flows.sync(this.renderRoot,{hass:this.hass,showFlows:this._show("show_flows"),batOverlays:this._show("show_battery")&&ws(this._config.battery),states:this._flowStates()});let r=!!(this._config?.title&&!ct(this._config.title));this.toggleAttribute("has-title",r)}render(){if(!this.hass)return I``;let i=this._device,r=!i;this._map=i?le(this.hass,i.ents):{};let l=this._config.title&&!ct(this._config.title)?this._config.title:"",h=this._show("show_battery");return I`<ha-card>
    ...
    </div>`:""}_renderBattery(){let i=pt(this._state("sensor.cms_batt_soc")),r=pt(this._state("sensor.bat_power")),l=r!=null&&r>vt,h=r!=null&&r<-vt,g=l?"charge":h?"discharge":"",E=l?this._t("card.charging"):h?this._t("card.discharging"):this._t("house.idle"),D=r!=null&&(l||h)?we(Math.abs(r)):null;return I`<div
    ...
    >
      ...
      </div>`}_summary(i){if(i==="appearance"){if(pr(this._config))return this._t("house.editor.custom");let r=this._config.house||It,l=this._config.house_mode||Re;return`${this._t("house.editor.style_n",{n:r})} \xB7 ${this._t(`house.mode.${l}`)}`}if(i==="display"){let r=en.filter(([l,h])=>this._config[l]??h);return r.length?r.map(([l])=>this._t(`house.short.${l}`)).join(", "):this._t("editor.nothing_shown")}if(i==="battery"){let r=this._config.show_battery??!0,l=this._t(`house.battery.${this._config.battery||xe}`);return r?l:this._t("editor.nothing_shown")}if(i==="entities"){let r=sn.filter(([l])=>this._config.entities?.[l]).length;return r?this._t("editor.overridden",{n:r}):this._t("editor.automatic")}return""}_renderSubpage(i){return I`<div class="subpage-head">
        <button class="back" @click=${()=>this._page=null}>
          <ha-icon icon="mdi:chevron-left"></ha-icon>
        </button>
        <span class="subpage-title">${this._t(`house.page.${i.id}`)}</span>
      </div>
      ${i.id==="appearance"?this._renderAppearancePage():i.id==="display"?en.map(([r,l,h])=>this._renderToggle(r,l,h)):i.id==="battery"?this._renderBatteryPage():this._renderEntitiesPage()}`}_renderAppearancePage(){let i=this._config.house||It,r=pr(this._config),l=this._config.house_mode||Re;return I`<div class="section">
      ...
      >
        ...
        >
      </button>`}_renderUploadSlot(i,r,l){let h=this._config[i]||"",g=this._uploading===i,E=this._t(`house.editor.custom_${r}`);return I`<div class="upload-slot">
      <div class="upload-slot-label">
        <ha-icon icon=${l}></ha-icon><span>${E}</span>
      </div>
      ...
      ${sn.map(([i,r])=>this._renderSlot(i,r))}`}_renderToggle(i,r,l){return I`<div class="row">
      <ha-icon icon=${l}></ha-icon>
      ...
      ></ha-switch>
    </div>`}_renderSlot(i,r){let l=this._config.entities?.[i]||"",h=this._defaults()[i],g=gt(l)&&!ct(l)?l:"";return I`<div class="slot">
...
`;var nn="sensor.grid_power",on="sensor.sys_grid_power",ln="sensor.pv_total",al="sensor.sys_load",hn="sensor.bat_power",cn="sensor.cms_batt_soc",an={center:"translate(-50%, -50%)","top-left":"translate(0, 0)","top-center":"translate(-50%, 0)","top-right":"translate(-100%, 0)","bottom-left":"translate(0, -100%)","bottom-center":"translate(-50%, -100%)","bottom-right":"translate(-100%, -100%)"},dn="var(--energy-solar-color, #ff9800)",pn="var(--energy-grid-consumption-color, #488fc2)",nl="var(--energy-grid-return-color, #8353d1)",fn="var(--energy-battery-in-color, #3ddc84)",ol="var(--energy-battery-out-color, #f06292)",$s={solar:{labelKey:"card.solar",icon:"mdi:solar-power-variant",slot:ln,format:"power",color:_=>_>vt?dn:null},grid:{labelKey:"house.grid",icon:"mdi:transmission-tower",slot:nn,slotFallback:on,format:"power-abs",color:_=>_>vt?pn:_<-vt?nl:null},battery:{labelKey:"card.battery",icon:"mdi:home-battery",slot:hn,format:"power-abs",color:_=>_>vt?fn:_<-vt?ol:null,secondarySlot:cn,secondaryUnit:"%"}},As={solar_today:{labelKey:"space.preset.solar_today",icon:"mdi:solar-power",color:dn,energyKey:"solar",format:"energy",secondaryKey:"space.today"},usage:{labelKey:"space.preset.usage",icon:"mdi:home-lightning-bolt",color:pn,energyKey:"consumption",format:"energy",secondaryKey:"space.today"},energy_independence:{labelKey:"space.preset.energy_independence",icon:"mdi:leaf",color:fn,energyKey:"independence",format:"percent"}},Es=class extends kt{static styles=rn;static get properties(){return{hass:{},_config:{},_tab:{state:!0}}}constructor(){super(),this._tab=0,this._flows=new gi,this._tmplUnsub={},this._tmplResults={},this._embed={path:null,status:null,els:[]},this._energy=void 0,this._energyTimer=null,this._clock="",this._clockTimer=null}connectedCallback(){super.connectedCallback(),Yt(),this._refreshEnergy(),this._energyTimer=setInterval(()=>this._refreshEnergy(),300*1e3),this._clock=this._formatClock(),this._clockTimer=setInterval(()=>{let i=this._formatClock();i!==this._clock&&(this._clock=i,this.requestUpdate())},1e3)}disconnectedCallback(){super.disconnectedCallback(),this._flows.destroy();for(let i of Object.values(this._tmplUnsub))typeof i=="function"&&i();this._tmplUnsub={},this._energyTimer&&clearInterval(this._energyTimer),this._energyTimer=null,this._clockTimer&&clearInterval(this._clockTimer),this._clockTimer=null}_formatClock(){let i=new Date;try{return i.toLocaleTimeString(this.hass?.locale?.language||void 0,{hour:"2-digit",minute:"2-digit"})}catch{return i.toTimeString().slice(0,5)}}firstUpdated(){let i=this;for(let r=0;r<8&&i;r++){let l=i.getRootNode?.()?.host;if(l&&/^hui-(card-preview|dialog-edit-card)/.test(l.localName||"")){this.toggleAttribute("in-preview",!0);break}i=l}}async _refreshEnergy(){if(!this.hass||!(this._config.tiles||[]).some(l=>As[l.preset]&&!ct(l.template)&&!(l.entity&&gt(l.entity))&&!l.slot))return;let r=await Ta(this.hass);this._energy=r,this.requestUpdate()}setConfig(i){this._config=i||{}}static getConfigElement(){return document.createElement(`${te}-editor`)}static getStubConfig(){return{tabs:[{id:"home",icon:"mdi:home",label:"Home"}],overlays:[{id:"solar",preset:"solar",x:30,y:27,anchor:"center"},{id:"grid",preset:"grid",x:22,y:62,anchor:"center"},{id:"battery",preset:"battery",x:52,y:62,anchor:"center"}],tiles:[{id:"solar",preset:"solar_today"},{id:"usage",preset:"usage"},{id:"independence",preset:"energy_independence"}],house:It}}getCardSize(){return 12}_t(i,r){return Ft(this.hass,i,r)}_show(i,r=!0){return this._config[i]??r}get _device(){let i=oe(this.hass);return i.length?this._config.device&&i.find(r=>r.deviceId===this._config.device)||i[0]:null}_slotEntity(i){return this._map?.[i]}_slotState(i){let r=this._slotEntity(i);return r?this.hass.states[r]:void 0}_grid(){let i=this._slotState(nn);return pt(i??this._slotState(on))}_flowStates(){let i=parseInt(this._config.house||It,10)||1;return this._device?{grid:this._grid(),solar:pt(this._slotState(ln)),load:pt(this._slotState(al)),bat:pt(this._slotState(hn)),soc:pt(this._slotState(cn)),route:i}:{grid:-400,solar:1500,load:700,bat:500,soc:65,route:i}}_moreInfo(i){i&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:i},bubbles:!0,composed:!0}))}async _syncTemplates(){if(!this.hass?.connection)return;let i=[];for(let r of this._config.overlays||[])ct(r.template)&&i.push(r.template),ct(r.secondary)&&i.push(r.secondary);for(let r of this._config.tiles||[])ct(r.template)&&i.push(r.template),ct(r.secondary)&&i.push(r.secondary);for(let r of i)if(!this._tmplUnsub[r]){this._tmplUnsub[r]=!0;try{this._tmplUnsub[r]=await this.hass.connection.subscribeMessage(l=>{this._tmplResults[r]=l.result,this.requestUpdate()},{type:"render_template",template:r})}catch{this._tmplResults[r]="\u26A0",this.requestUpdate()}}for(let r of Object.keys(this._tmplUnsub))if(!i.includes(r)){let l=this._tmplUnsub[r];typeof l=="function"&&l(),delete this._tmplUnsub[r],delete this._tmplResults[r]}}_fmt(i,r){let l=Number(r);return i==="power"?he(l):i==="power-abs"?he(Math.abs(l)):i==="energy"?ms(l):i==="percent"?{n:Number.isFinite(l)?String(Math.round(l)):"\u2013",u:"%"}:{n:r==null||r===""?"\u2013":String(r),u:""}}_overlayView(i){let r=i.preset?$s[i.preset]:null,l={label:i.label??(r?this._t(r.labelKey):""),icon:i.icon??r?.icon,num:"",unit:"",color:i.color||null,entityId:i.tap_entity||null,secondary:"",dot:i.dot};if(ct(i.template)){let h=this._tmplResults[i.template];l.num=h==null?"\u2026":String(h),l.unit=h==null?"":i.unit||""}else{let h=i.entity&&gt(i.entity)&&i.entity||i.slot&&this._slotEntity(i.slot)||r?.slot&&this._slotEntity(r.slot)||r?.slotFallback&&this._slotEntity(r.slotFallback)||null,g=h?this.hass.states[h]:null;if(g){let E=i.attribute?g.attributes?.[i.attribute]:g.state;if(r?.format){let D=this._fmt(r.format,E);l.num=D.n,l.unit=i.unit??D.u,!l.color&&r.color&&(l.color=r.color(Number(E)))}else l.num=E==null||E===""?"\u2013":String(E),l.unit=l.num==="\u2013"?"":i.unit??(i.attribute?"":g.attributes?.unit_of_measurement||"");if(l.entityId=i.tap_entity||h,r?.secondarySlot){let D=this._slotEntity(r.secondarySlot),U=D?this.hass.states[D]:null,j=U?Number(U.state):NaN;Number.isFinite(j)&&(l.secondary=`${Math.round(j)}${r.secondaryUnit||""}`)}}else l.entityId=i.tap_entity||h}return i.secondary&&(l.secondary=this._resolveValue(i.secondary)),l}_tileView(i){let r=i.preset?As[i.preset]:null,l={label:i.label??(r?this._t(r.labelKey):""),icon:i.icon??r?.icon,color:i.color||r?.color||null,num:"\u2013",unit:"",entityId:i.tap_entity||null,secondary:""},h=ct(i.template)||i.entity&&gt(i.entity)||i.slot;if(r&&!h){let g=this._energy?this._energy[r.energyKey]:null;if(g!=null){let E=this._fmt(r.format,g);l.num=E.n,l.unit=i.unit??E.u}}else if(ct(i.template)){let g=this._tmplResults[i.template];l.num=g==null?"\u2026":String(g),l.unit=g==null?"":i.unit||""}else{let g=i.entity&&gt(i.entity)&&i.entity||i.slot&&this._slotEntity(i.slot)||null,E=g?this.hass.states[g]:null;if(E){let D=i.attribute?E.attributes?.[i.attribute]:E.state;if(r?.format){let U=this._fmt(r.format,D);l.num=U.n,l.unit=i.unit??U.u}else l.num=D==null||D===""?"\u2013":String(D),l.unit=l.num==="\u2013"?"":i.unit??(i.attribute?"":E.attributes?.unit_of_measurement||"");l.entityId=i.tap_entity||g}}return l.secondary=i.secondary?this._resolveValue(i.secondary):r?.secondaryKey?this._t(r.secondaryKey):"",l}_resolveValue(i){if(!i)return"";if(ct(i)){let r=this._tmplResults[i];return r==null?"\u2026":String(r)}if(gt(i)){let r=this.hass.states[i];if(!r)return"";let l=r.attributes?.unit_of_measurement;return l?`${r.state} ${l}`:r.state}return i}updated(i){super.updated(i),this._syncTemplates(),this._activeTab().id==="home"?this._flows.sync(this.renderRoot,{hass:this.hass,showFlows:this._show("show_flows"),batOverlays:this._show("show_battery")&&ws(this._config.battery),states:this._flowStates()}):this._syncEmbed()}_activeTab(){let i=this._tabs();return i[this._tab]||i[0]}_tabs(){let i=this._config.tabs&&this._config.tabs.length?[...this._config.tabs]:[{id:"home",icon:"mdi:home",label:"Home"}];return i[0]={...i[0],id:"home",icon:i[0].icon||"mdi:home"},i}async _syncEmbed(){let i=this.renderRoot?.querySelector(".embed-host");if(!i)return;let l=this._activeTab()?.path||"";if(l&&l===this._embed.path){for(let h of this._embed.els)h.hass=this.hass;return}if(this._embed={path:l,status:"loading",els:[]},i.innerHTML="",!l){this._embed.status="empty";return}try{let h=await this._fetchView(l);if(!h){this._embed.status="missing",i.innerHTML="",this.requestUpdate();return}let g=await window.loadCardHelpers?.();if(!g)throw new Error("card helpers unavailable");let E=[...h.cards||[]];for(let U of h.sections||[])E.push(...U.cards||[]);let D=[];for(let U of E)try{let j=g.createCardElement(U);j.hass=this.hass,i.appendChild(j),D.push(j)}catch{}if(this._activeTab()?.path!==l){i.innerHTML="";return}this._embed={path:l,status:"ready",els:D}}catch{this._embed.status="error",this.requestUpdate()}}async _fetchView(i){let r=String(i).split("/").filter(Boolean),l=r.length>1?r[0]:null,h=r.length>1?r.slice(1).join("/"):r[0],E=(await this.hass.connection.sendMessagePromise({type:"lovelace/config",url_path:l}))?.views||[],D=E.find(U=>U.path===h);return!D&&/^\d+$/.test(h)&&(D=E[Number(h)]),D}render(){if(!this.hass)return I``;let i=this._device;this._map=i?le(this.hass,i.ents):{};let r=this._tabs(),l=r[this._tab]||r[0],h=this._config.rail_labels??!1,g=this._config.rail_align||"start";return I`<ha-card>
        ...
        <nav class="rail align-${g} ${h?"has-labels":""}">
          ${r.map((E,D)=>I`<button
            ...
            >
              ...
              ${h&&E.label?I`<span class="rail-label">${E.label}</span>`:""}
            </button>`)}
        </nav>
        <div class="main">
    ...
    </ha-card>`}_needsDevice(){let i=r=>!r.entity&&!ct(r.template)&&(r.slot||$s[r.preset]);return(this._config.overlays||[]).some(i)}_renderHome(){let i=this._show("show_battery"),r=!this._device&&this._needsDevice();return I`<div class="stage-wrap">
      ${this._renderTopBar()}
      <div class="stage">
    ...
    </div>`}_renderWeather(){let i=this._config.weather?.entity,r=i?this.hass.states[i]:null;if(!r)return I`<div class="topbar-right"></div>`;let l=r.attributes||{},h=l.temperature_unit||this.hass.config?.unit_system?.temperature||"\xB0",g=this._resolveValue(this._config.weather?.low),E="";if(g!=="")E=g;else if(Array.isArray(l.forecast)&&l.forecast.length){let U=l.forecast[0].templow??l.forecast[0].temperature;U!=null&&(E=`${Math.round(U)} ${h}`)}let D=this._config.weather_size||1;return I`<div class="topbar-right">
      <button
        class="weather"
        style=${`--ef-scale:${D}`}
        ...
        title=${r.state}
      >
        ${l.temperature!=null?I`<span class="w-grp"
              ><ha-icon icon="mdi:thermometer"></ha-icon
              ><span>${Math.round(l.temperature)} ${h}</span></span
            >`:""}
        ${l.humidity!=null?I`<span class="w-grp"
              ><ha-icon icon="mdi:water-percent"></ha-icon
              ><span>${Math.round(l.humidity)} %</span></span
            >`:""}
        ${E?I`<span class="w-grp moon"
              ><ha-icon icon="mdi:weather-night"></ha-icon
              ><span>${E}</span></span
            >`:""}
      </button>
    </div>`}_renderOverlays(){let i=this._config.overlays||[];return i.length?I`<div class="overlays">
      ${i.map(r=>{let l=this._overlayView(r),h=`left:${r.x??50}%;top:${r.y??50}%;transform:${an[r.anchor]||an.center};--ef-scale:${r.size||1};${l.color?`--ef-ov-color:${l.color};`:""}`;return I`<button
          class="overlay ${l.entityId?"clickable":""}"
          style=${h}
          @click=${()=>this._moreInfo(l.entityId)}
        >
          ${l.label?I`<span class="ov-label"
                >${l.icon?I`<ha-icon class="ov-ic" icon=${l.icon}></ha-icon>`:""}
                <span>${l.label}</span>
                ${r.dot?I`<span class="ov-dot" style=${`background:${r.dot}`}></span>`:""}</span
              >`:""}
          ${l.num!==""?I`<span class="ov-value"
                ><span class="ov-num">${l.num}</span
                >${l.unit?I`<span class="ov-unit">${l.unit}</span>`:""}
                ${l.secondary?I`<span class="ov-sec">· ${l.secondary}</span>`:""}</span
              >`:""}
        </button>`})}
      ...
      ${i.map(l=>{let h=this._tileView(l),g=h.secondary.startsWith("+")?"pos":h.secondary.startsWith("-")?"neg":"";return I`<button
          class="tile ${h.entityId?"clickable":""}"
          @click=${()=>this._moreInfo(h.entityId)}
        >
          <div class="tile-head">
      ...
      ${i.id==="appearance"?this._renderAppearance():i.id==="weather"?this._renderWeather():i.id==="overlays"?this._renderOverlays():i.id==="tiles"?this._renderTiles():this._renderTabs()}`}_renderAppearance(){let i=this._config.house||It,r=this._config.house_mode||Re,l=this._config.battery||xe;return I`<div class="section">
        <ha-icon icon="mdi:home-outline"></ha-icon>${this._t("house.editor.style")}
      </div>
      <div class="grid">
        ${ei.map(h=>I`<button
      ...
      ${cl.map(([h,g,E])=>this._renderToggle(h,g,E))}`}_renderToggle(i,r,l){return I`<div class="row">
      <ha-icon icon=${l}></ha-icon>
      <span class="row-label">${this._t(`house.toggle.${i}`)}</span>
      <ha-switch
        .checked=${this._config[i]??r}
      ...
      ${this._config.clock?this._scaleField(this._t("space.f_clock_size"),this._config.clock_size,r=>this._set("clock_size",r,1)):""}`}_setWeather(i,r){let l={...this._config.weather||{}};r?l[i]=r:delete l[i];let h={...this._config,weather:l,type:`custom:${te}`};Object.keys(l).length||delete h.weather,this._dispatch(h)}_renderOverlays(){let i=this._config.overlays||[];return I`<div class="hint top-hint">${this._t("space.overlays_hint")}</div>
      <div
        class="preview"
      ...
      </button>`}_renderOverlayEditor(i,r){let l=this._sel===i.id,h=this._sourceMode(i);return I`<div class="item ${l?"open":""}">
    ...
    </div>`}_renderPresetField(i,r,l,h){let g=["",...Object.keys(h)];return I`${this._selectField(this._t("space.f_preset"),g,r.preset||"",E=>{let D={preset:E||void 0};E&&(D.slot=void 0,D.entity=void 0,D.template=void 0),this._updateItem(i,l,D)},E=>E?this._t(`space.preset.${E}`):this._t("space.preset_none"))}
      ${r.preset?I`<div class="hint">${this._t("space.preset_hint")}</div>`:""}`}_sourceMode(i){return this._modes[i.id]?this._modes[i.id]:ct(i.template)?"template":i.entity?"entity":"auto"}_renderSourceField(i,r,l,h){return I`<div class="src-modes">
        ${["auto","entity","template"].map(g=>I`<button
            class="mode ${h===g?"on":""}"
            @click=${()=>{this._modes={...this._modes,[r.id]:g};let E={slot:void 0,entity:void 0,template:void 0};this._updateItem(i,l,E)}}
          >
            ${this._t(`space.src_${g}`)}
          </button>`)}
      </div>
      ${h==="auto"?this._selectField(this._t("space.f_slot"),Ts,r.slot||Ts[0],g=>this._updateItem(i,l,{slot:g}),g=>this._t(`slot.${g}`)):h==="entity"?I`<ha-form
              .hass=${this.hass}
            ...
            ></ha-form>`}`}_addOverlay(){let i=[...this._config.overlays||[]],r=fr("ov");i.push({id:r,label:"Overlay",x:50,y:50,anchor:"center",slot:Ts[0]}),this._setList("overlays",i),this._sel=r}_renderTiles(){let i=this._config.tiles||[];return I`<div class="hint top-hint">${this._t("space.tiles_hint")}</div>
      ...
      </button>`}_renderTileEditor(i,r){let l=this._sel===i.id,h=this._sourceMode(i);return I`<div class="item ${l?"open":""}">
      <div class="item-head" @click=${()=>this._sel=l?null:i.id}>
    ...
    </div>`}_addTile(){let i=[...this._config.tiles||[]],r=fr("tile");i.push({id:r,label:"Tile",slot:Ts[0]}),this._setList("tiles",i),this._sel=r}_tabs(){return this._config.tabs&&this._config.tabs.length?this._config.tabs:[{id:"home",icon:"mdi:home",label:"Home"}]}_renderTabs(){let i=this._tabs();return I`<div class="row">
    ...
    </div>`}_renderTabEditor(i,r){let l=this._sel===`tab${r}`;return I`<div class="item ${l?"open":""}">
    ...
    </div>`}_addTab(){let i=[...this._tabs()];i.push({id:fr("tab"),icon:"mdi:view-dashboard-outline",label:"View",path:""}),this._setList("tabs",i),this._sel=`tab${i.length-1}`}_textField(i,r,l,h){return I`<ha-form
      class="field"
      .hass=${this.hass}
      .data=${{value:r??""}}
      .schema=${[{name:"value",selector:{text:{}}}]}
      .computeLabel=${()=>i}
      .computeHelper=${()=>h||""}
      @value-changed=${g=>{g.stopPropagation(),l(g.detail.value.value??"")}}
    ></ha-form>`}_numField(i,r,l){return I`<ha-form
      class="field num"
      .hass=${this.hass}
      .data=${{value:r}}
      .schema=${[{name:"value",selector:{number:{min:0,max:100,mode:"box"}}}]}
      .computeLabel=${()=>i}
      @value-changed=${h=>{let g=Number(h.detail.value.value);Number.isFinite(g)&&l(Math.max(0,Math.min(100,Math.round(g))))}}
    ></ha-form>`}_scaleField(i,r,l){return I`<ha-form
      class="field"
      .hass=${this.hass}
      .data=${{value:r??1}}
      .schema=${[{name:"value",selector:{number:{min:.5,max:3,step:.1,mode:"slider"}}}]}
      .computeLabel=${()=>i}
      @value-changed=${h=>{h.stopPropagation();let g=Number(h.detail.value.value);l(Number.isFinite(g)?g:1)}}
    ></ha-form>`}_selectField(i,r,l,h,g){let E=r.map(D=>({value:D,label:g?g(D):D||"\u2014"}));return I`<ha-form
      class="field"
      .hass=${this.hass}
      .data=${{value:l}}
